describe('hashTable', function() {
  ...
  it('should execute a callback for each item using each', function(){
    hashTable.insert('Bob', 'Loblaw');
    hashTable.insert('Steven', 'Barker');
    hashTable.insert('Vince', 'Blah');
    hashTable.insert('Griffin', 'lastName');
    var countBarker = 0;
    var count = 0;
    hashTable.each(function(tuple){
      if(tuple.value==='Barker'){
        countBarker++;
      }
      count++;
    });
    expect(countBarker).to.equal(1);
